...
angular.module('wscene.controllers', []).controller('HomeController',
        ...
        function($scope, $location, $timeout, $activityIndicator, preloader, $http, IssuePostService, audioService) {
            ...
            IssuePostService.fetchIssuePost('45186ed22c63bcb9f3607548c61c5ebb').then(function(data) {
                console.log(data)
            ...
            function init(response) {
                ...
                angular.forEach(response.root.page, function(data, index, array) {
                    $scope.imageLocations.push(data['@smallurl'])
                });
                ...
                $scope.datas = response.root.page;
                //load music
                if (response.music) {
        ...
        return {
            controller: function($scope, $element, $attrs, $timeout, $location) {
                ...
                var t = 0,
                    r = 0,
                    n = 0,
                    u = $scope.pagecount * $scope.style.pageW;
                $scope.$watch($scope.style.pageH, function(newVal, oldVal) {
